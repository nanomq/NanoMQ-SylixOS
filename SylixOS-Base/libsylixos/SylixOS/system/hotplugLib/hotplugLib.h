...
#define LW_HOTPLUG_MSG_DISPLAY          0x2300
#define LW_HOTPLUG_MSG_DISPLAY_CHANGE   (LW_HOTPLUG_MSG_DISPLAY + 1)    /*  显示热插拔消息              */
#define LW_HOTPLUG_MSG_DISPLAY_USING    (LW_HOTPLUG_MSG_DISPLAY + 2)    /*  显示忙碌状态变化消息        */
