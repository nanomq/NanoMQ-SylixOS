...
#define LW_CFG_LWIP_TCP_PCB             512                             /*  允许同时的 TCP 连接数       */
#define LW_CFG_LWIP_UDP_PCB             256                             /*  允许同时的 UDP 数量         */
#define LW_CFG_LWIP_RAW_PCB             64                              /*  允许同时的 RAW 数量         */
...
#define LW_CFG_NET_SCTP_EN              1                               /*  此协议支持由外部模块提供    */
