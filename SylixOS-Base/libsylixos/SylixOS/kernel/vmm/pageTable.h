...
/*********************************************************************************************************
  注意: LW_VMM_FLAG_PHY_CONTINUOUS 标志, 为 CETC 14 Institute 特殊需求,
        仅用于 API_VmmMallocEx() 与 API_VmmMallocAlign().
*********************************************************************************************************/

#define LW_VMM_FLAG_PHY_CONTINUOUS      0x80000000                      /*  物理地址空间连续            */
#define LW_VMM_FLAG_PHY_OPTIMIZE        0x00000000                      /*  最优使用物理地址空间        */
